...
def test_o_line():
    np.testing.assert_array_equal(df["OnOffensiveLine"].head(), [False, False, False, False, False])


def test_d_line():
    np.testing.assert_array_equal(df["OnDefensiveLine"].head(), [False, True, True, False, False])
...
def test_dl_S_x():
    np.testing.assert_approx_equal(output.iloc[0]["dl_S_x"], -0.4000891943949796)


def test_ol_S_x():
    np.testing.assert_approx_equal(output.iloc[0]["ol_S_x"], 5.84584489733794)


def test_dl_S_y():
    np.testing.assert_approx_equal(output.iloc[0]["dl_S_y"], 1.611281024700446)


def test_ol_S_y():
    np.testing.assert_approx_equal(output.iloc[0]["ol_S_y"], 3.3860411814859006)
